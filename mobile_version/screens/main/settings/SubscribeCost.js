  ...
  return (
    <View style={[s.container, s.backColor]}>
      ...
      <View style={[s.topBar, s.flexRow, s.spaceBtw, s.aCenter, s.statBarMargin]}>
        ...
        <Text style={[s.text24, s.factorBold, s.textBlack]}>{text[lang].price}</Text>
      ...
      { switch1
        ?
        <View style={[s.mt15]}>
          <Text style={[s.text14, s.factor, s.textGrey, s.mh15, s.mt15, { color: '#ddd' }]}>{text[lang].monthCost}</Text>
        ...
        :
        <View style={[s.mt15]}>
          <Text style={[s.text14, s.factor, s.textBlack, s.mh15, s.mt15]}>{text[lang].monthCost}</Text>
