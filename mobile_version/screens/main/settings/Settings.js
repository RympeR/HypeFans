  ...
  return (
    <View style={[s.container, s.backColor]}>
      ...
      <View style={[s.topBar, s.flexRow, s.spaceBtw, s.aCenter, s.statBarMargin]}>
        ...
        <Text style={[s.text24, s.factorBold, s.textBlack]}>{text[lang].settings}</Text>
      ...
      >
        <Text style={[s.text18, s.factor, s.textBlack]}>{text[lang].profile}</Text>
        <View style={[s.mh15]}>
          <SvgUri width="16" height="16"
      ...
      >
        <Text style={[s.text18, s.factor, s.textBlack]}>{text[lang].account}</Text>
        <View style={[s.mh15]}>
          <SvgUri width="16" height="16"
            source={require('../../../assets/images/forward.svg')} />
        </View>
      ...
      >
        <Text style={[s.text18, s.factor, s.textBlack]}>{text[lang].security}</Text>
        <View style={[s.mh15]}>
          <SvgUri width="16" height="16"
            source={require('../../../assets/images/forward.svg')} />
        </View>
      ...
      <TouchableOpacity style={[s.h53, s.aCenter, s.flexRow, s.spaceBtw, s.ml15]}
        ...
        onPress={() => navigation.navigate('NoteSettings')}
      >
        <Text style={[s.text18, s.factor, s.textBlack]}>{text[lang].notifications}</Text>
        <View style={[s.mh15]}>
          <SvgUri width="16" height="16"
            source={require('../../../assets/images/forward.svg')} />
        </View>
