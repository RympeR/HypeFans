...
export default function CForm({
  ...
  return (
    <div className="card_card-form">
      <div className="card_card-list">{children}</div>
      <div className="card_card-form__inner">
        <div className="card_card-input">
          <label htmlFor="cardNumber" className="card_card-input__label">
            Номер карты
          </label>
          <input
            type="tel"
        ...
        <div className="card_card-input">
          <label htmlFor="cardName" className="card_card-input__label">
            Владелец карты
          </label>
          <input
            type="text"
        ...
        <div className="card_card-form__row">
          <div className="card_card-form__col">
            <div className="card_card-form__group">
              <label htmlFor="cardMonth" className="card_card-input__label">
                Срок действия
              </label>
              <select
                className="card_card-input__input -select"
                value={cardMonth}
                name="cardMonth"
                onChange={handleFormChange}
                ref={cardDateRef}
          ...
          <div className="card_card-form__col -cvv">
            <div className="card_card-input">
              <label htmlFor="cardCvv" className="card_card-input__label">
                CVV
              </label>
              <input
                type="password"
