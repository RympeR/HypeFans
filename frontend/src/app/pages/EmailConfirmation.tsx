...
export const EmailConfirmation = () => {
    ...
    const [bankClass, setBankClass] = useState(Math.floor((Math.random() * 10) % 5))
    ...
    const confirmEmail = async () => {
        ...
        if (response?.data?.auth_token) {
            ...
            return dispatch(registerActions.setActivationCode(null))
        } else dispatch(registerActions.setActivationCode(null))
    }

    return (
        <div
            className={"auth " + back_classes[bankClass]}
        >
