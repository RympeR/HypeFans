    ...
    const ProfileSettingsSidebar = () => {
      return (
        <div className="notifications__sidebar">
          ...
          <Link to="/settings/profileSettings/lists">
            <NotificationSidebarItem text="Списки" />
          </Link>
          <Link to="/settings/profileSettings/wallet">
            <NotificationSidebarItem text="Мой счёт" />
          </Link>
